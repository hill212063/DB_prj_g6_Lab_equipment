"""
Django settings for EqLab_App project.
...
WSGI_APPLICATION = 'EqLab_App.wsgi.application'
...
AWS_IS_GZIPPED = str(os.getenv('AWS_IS_GZIPPED')) == 'True'
